...
final List<ImportantTag> importantTags = [
  const ImportantTag(title: '私の紹介', color: Color(0xFFFFC2BE), tags: [
  ...
  const ImportantTag(title: '過ごし方', color: Color(0xFFFFCE95), tags: [
  ...
  const ImportantTag(title: '信条', color: Color(0xFFFFFFB2), tags: [
  ...
  const ImportantTag(title: '趣味嗜好', color: Color(0xFFC0E1FE), tags: [
