...
import 'package:minden/features/token/domain/usecases/get_token.dart';
...
void main() {
  ...
  setUp(() {
    ...
    usecase = GetToken(mockTokenRepository);
  });
  ...
  test('should get token', () async {
    when(mockTokenRepository.getToken(tRefreshToken))
        .thenAnswer((_) async => const Right(tToken));

    final result = await usecase(const Params(refreshToken: tRefreshToken));

    expect(result, const Right(tToken));
    verify(mockTokenRepository.getToken(tRefreshToken));
